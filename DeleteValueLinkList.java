...
public class DeleteValueLinkList
{
...
// linked list 
    ...
    /* Given a key, deletes the first occurrence of key in linked list ,delete node value wise*/
    ...
    { 
        DeleteValueLinkList llist = new DeleteValueLinkList(); 
